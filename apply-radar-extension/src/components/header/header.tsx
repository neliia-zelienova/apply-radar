...
export const Header = () => {
    ...
    return (
        <div className="fixed z-10 top-0 left-0 w-full p-4 bg-stone-50 dark:bg-teal-600 flex flex-col items-start gap-2 shadow-sm shadow-teal-100/30">
            ...
            <button className='px-4 py-2 rounded-md border border-gray-300 bg-white text-sm text-sky-900 flex items-center hover:bg-gray-100 hover:border-blue-950 hover:shadow-md hover:shadow-blue-950/10 transition-colors ease-linear duration-150 cursor-pointer' onClick={showNewAppForm}>
